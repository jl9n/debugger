...
function ckstyle() { //定义总的风格
	...
	*/
	...
	以下是播放器自带的二个插件
	*/
	control_rel:'related.swf,__PUBLIC__/ckplayer/related.xml,0',
	/*
	视频结束显示精彩视频的插件
	...
	*/
	advmarquee:escape('{a href=""}{font color="#FFFFFF" size="12"}　四小A项目组(张秀波、张洪岩、董其贤、何亚萍)　{/font}{/a}'),
	/*
	...
	*/
	cpt_share:'__PUBLIC__/ckplayer/share.xml',
	/*
	分享插件调用的配置文件地址
	调用插件开始
	*/
