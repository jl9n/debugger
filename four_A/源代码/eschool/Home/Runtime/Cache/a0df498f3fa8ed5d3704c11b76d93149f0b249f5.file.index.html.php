<?php /* Smarty version Smarty-3.1.6, created on 2014-03-03 21:15:05
         compiled from "./Home/Tpl\Index\index.html" */ ?>
<?php /*%%SmartyHeaderCode:165453148059a96578-53978914%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '165453148059a96578-53978914',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5314805a4ae55',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5314805a4ae55')) {function content_5314805a4ae55($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\AppServ\\www\\eschool\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
if (!is_callable('smarty_modifier_date_format')) include 'C:\\AppServ\\www\\eschool\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        
        <title>E-Sch教学网_最有影响力的在线教育网</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav g_nav">
                        <li><a href="__APP__/Video/index" class="btn btn-primary btn-signup animated">视频</a></li>
                        <li><a href="__APP__/Note/index" class="btn btn-primary btn-signup animated">手记</a></li>
                        <li><a href="__APP__/Library/index" class="btn btn-primary btn-signup animated">军火库</a></li>
                        <li><a href="__APP__/Message/index" class="btn btn-primary btn-signup animated">贴吧</a></li>
                        <?php if ($_SESSION['user']){?>
                            <li><a href="__APP__/Test/index" class="btn btn-primary btn-signup animated">考试</a></li>
                            <?php }else{ ?>
                            <li><a href="javascript:alert('请先登录！')" class="btn btn-primary btn-signup animated">考试</a></li>
                            <?php }?>
                    </ul>
...
" class="play-btn" title="点击播放"><i class="icon-play"></i></a>
        ...
        <div class="home_module m_hot">
            <div class="container">
                <div class="col-md-2">
                    <h2><a href="javascript:void(0)">热点</a></h2>
                    <ul>
                        <li><a href=""></a></li>
                    ...
                    <div class="hot-content-list">
                        ...
                        <div class="hot-c-r" style='width:100%'>
                            ...
                            <div class="hot-comment">
                                <div class="hot-comment-title">新片抢先看 Top-Three</div>
                                <ul>
...
"><?php echo $_smarty_tpl->tpl_vars['vith']->value['videoname'];?>
                            ...
                            <div class="hot-comment">
                                <div class="hot-comment-title">军火 Top-Three</div>
...
"><?php echo $_smarty_tpl->tpl_vars['new']->value['username'];?>
                            ...
                            <div class="hot-comment">
                                <div class="hot-comment-title">手记 Top-Three</div>
