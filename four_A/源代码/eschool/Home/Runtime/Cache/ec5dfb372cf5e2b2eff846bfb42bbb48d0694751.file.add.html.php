<?php /* Smarty version Smarty-3.1.6, created on 2014-03-05 23:25:52
         compiled from "./Home/Tpl\Library\add.html" */ ?>
<?php /*%%SmartyHeaderCode:2074531742008dd4d2-05729747%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2074531742008dd4d2-05729747',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53174200bc709',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53174200bc709')) {function content_53174200bc709($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\AppServ\\www\\eschool\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\function.html_options.php';
?><!DOCTYPE html>
<html lang="en">
    <head>
        <title>添加军火</title>
...
">
                ...
                <div class="col-md-4">
                    <div class="bg_f5 p20 mt40 f12">
                        上传资源，即表示您已同意<a data-toggle="modal" href="#myModal">E-Sch教学网上传服务条款</a>，请勿上传垃圾等不合理资源。
                        <br/>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">E-Sch教学网上传服务条款</h4>
            </div>
